...
//        String projectPath = System.getProperty("user.dir")
        ...
        // 修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/bikescreen?useUnicode=true&characterEncoding=UTF8&useSSL=false");
        ...
        // 模块配置
        pc.setParent("com.longyi.bikescreen")
                .setEntity("entity")
                .setMapper("mapper")
                .setService("service")
        ...
        System.out.println("user,menu,bike,platform,invert,bikeorder,recovery,income,notice");
